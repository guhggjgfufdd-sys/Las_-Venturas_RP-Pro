...
* شاشة أخبار عربية داخل اللانشر.
* شاشة قوانين تظهر لمدة 10 ثوانٍ قبل تشغيل اللعبة ثم تدخل تلقائيًا إلى Las Venturas RP.
* قفل كامل على السيرفر الرسمي 142.132.203.47:21299 ومنع إضافة سيرفرات خارجية.
* حركة افتتاحية للشعار مع بقاء إعدادات المايك، MonetLoader، المودات وملفات العميل الأصلية.
